...
`yabboq_osm_waterways_clip.gpkg`
...
1. `01_prepare_dem.py`
2. `02_derive_terrain.py`
3. `03b_compare_reference_hydrography.py`
4. `03c_summarize_threshold_sweep.py`
5. `04_null_background_test.py`
6. `05_terrain_matched_null.py`
7. `06_build_final_comparison.py`
8. `07_plot_final_comparison.py`

The QGIS project is stored as:

`Yabboq_GIS_Project.qgz`
...
`outputs\final_comparison\figures`
